...
{
  new (message_memory) motpy_pifpaf_msg::msg::Pose(_init);
}

void Pose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<motpy_pifpaf_msg::msg::Pose *>(message_memory);
  typed_message->~Pose();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose_message_member_array[1] = {
  {
    ...
    offsetof(motpy_pifpaf_msg::msg::Pose, keypoints),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pose_message_members = {
  ...
  "Pose",  // message name
  1,  // number of fields
  sizeof(motpy_pifpaf_msg::msg::Pose),
...
{
  return &::motpy_pifpaf_msg::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motpy_pifpaf_msg, msg, Pose)() {
  return &::motpy_pifpaf_msg::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
