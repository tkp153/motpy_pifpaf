...
#include "motpy_pifpaf_msg/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
using _Pose__ros_msg_type = motpy_pifpaf_msg__msg__Pose;
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_motpy_pifpaf_msg__msg__Pose(
...
{
  return max_serialized_size_motpy_pifpaf_msg__msg__Pose(
    full_bounded, 0);
}
