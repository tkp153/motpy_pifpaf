...
static const _Pose_type_support_symbol_names_t _Pose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motpy_pifpaf_msg, msg, Pose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motpy_pifpaf_msg, msg, Pose)),
  }
};
...
get_message_type_support_handle<motpy_pifpaf_msg::msg::Pose>()
{
  return &::motpy_pifpaf_msg::msg::rosidl_typesupport_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motpy_pifpaf_msg, msg, Pose)() {
  return get_message_type_support_handle<motpy_pifpaf_msg::msg::Pose>();
}
