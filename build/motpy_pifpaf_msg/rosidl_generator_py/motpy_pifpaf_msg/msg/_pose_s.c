...
bool motpy_pifpaf_msg__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motpy_pifpaf_msg.msg._pose.Pose", full_classname_dest, 31) == 0);
  }
  motpy_pifpaf_msg__msg__Pose * ros_message = _ros_message;
  {  // keypoints
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->keypoints.data;
...
PyObject * motpy_pifpaf_msg__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motpy_pifpaf_msg.msg._pose");
  ...
  {  // keypoints
    ...
    if (ros_message->keypoints.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->keypoints.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->keypoints.size * sizeof(float));
      assert(data != NULL);
